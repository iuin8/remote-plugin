...
object SshSetupManager {
    ...
    private fun generateSshKeyPairIfNeeded(projectRootDir: File, sshDir: File) {
        ...
        if (remoteYmlFile.exists()) {
            try {
                ...
                autoKeygen = config["ssh.setup.auto.keygen"]?.toBoolean() ?: false
            } catch (e: Exception) {
    ...
    private fun generateRemoteYml(remotePluginDir: File) {
        ...
        try {
            ...
            remoteYmlFile.writeText(getRemoteYmlTemplate())
    ...
    private fun generateSshConfig(sshDir: File) {
        ...
        try {
            ...
            configFile.writeText(getSshConfigTemplate())
     ...
     * 获取 remote.yml 模板内容
     */
    private fun getRemoteYmlTemplate(): String {
        return "# Remote plugin configuration template\n" +
     ...
     * 获取 .ssh/config 模板内容
     */
    private fun getSshConfigTemplate(): String {
        return "# SSH Config for Gradle Remote Plugin\n" +
                "# Generated by Gradle Remote Plugin\n" +
